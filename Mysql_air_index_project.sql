...
Data are stored in csv file. Dataset contains 21 columns and 7,323 rows
...
WITH cte AS 
 ...
 -- when the city and country is the same and values of air index are different for particular columns
 -- I set the avarge value for those cells, when one value is null I set a value from row which contains value. This is the reason
 -- why I do not change null to zero when I calculate avg
    ...
    -- I used RIGH JOIN to show all cleaned values. 
...
-- 1) What country has the most polluted air in each year (top 10 countries)?
-- in 2022
...
SELECT Country, ROUND(SUM(COALESCE(`2021`, 0)),2) AS sum_2022 
FROM cleaned_data_air_index
GROUP BY 1
ORDER BY 2 DESC
LIMIT 10;
...
SELECT Country, ROUND(SUM(COALESCE(`2020`, 0)),2) AS sum_2022 
FROM cleaned_data_air_index
GROUP BY 1
ORDER BY 2 DESC
LIMIT 10;
...
SELECT Country, ROUND(SUM(COALESCE(`2019`, 0)),2) AS sum_2022 
FROM cleaned_data_air_index
GROUP BY 1
ORDER BY 2 DESC
LIMIT 10;
...
SELECT Country, ROUND(SUM(COALESCE(`2018`, 0)),2) AS sum_2022 
FROM cleaned_data_air_index
GROUP BY 1
ORDER BY 2 DESC
LIMIT 10;
...
SELECT Country, ROUND(SUM(COALESCE(`2017`, 0)),2) AS sum_2022 
FROM cleaned_data_air_index
GROUP BY 1
ORDER BY 2 DESC
LIMIT 10;
...
-- 3) What country has the biggest air polution within 6 years (top 10)
SELECT Country, 
...
-- 4) What City has the biggest air polution within 6 years (top 10)
SELECT Country, City,
IFNULL(SUM(`2022`),0) + IFNULL(SUM(`2021`),0) + IFNULL(SUM(`2020`),0) + 
IFNULL(SUM(`2019`),0) + IFNULL(SUM(`2018`),0) + IFNULL(SUM(`2017`),0) AS total_air_index 
FROM cleaned_data_air_index
...
-- 5) What country has the least air polution within 6 years (top 10)
SELECT Country, 
IFNULL(SUM(`2022`),0) + IFNULL(SUM(`2021`),0) + IFNULL(SUM(`2020`),0) + 
IFNULL(SUM(`2019`),0) + IFNULL(SUM(`2018`),0) + IFNULL(SUM(`2017`),0) AS total_air_index 
FROM cleaned_data_air_index
...
-- 6) What City has the biggest air polution within 6 years (top 10)
SELECT Country, City,
IFNULL(SUM(`2022`),0) + IFNULL(SUM(`2021`),0) + IFNULL(SUM(`2020`),0) + 
IFNULL(SUM(`2019`),0) + IFNULL(SUM(`2018`),0) + IFNULL(SUM(`2017`),0) AS total_air_index 
FROM cleaned_data_air_index
...
-- 7) The avarage air index for each country within 6 years

SELECT Country, ROUND((IFNULL(SUM(`2022`),0) + IFNULL(SUM(`2021`),0) + IFNULL(SUM(`2020`),0) + 
IFNULL(SUM(`2019`),0) + IFNULL(SUM(`2018`),0) + IFNULL(SUM(`2017`),0))/6 ,2) AS avg_air_index 
FROM cleaned_data_air_index
GROUP BY 1
ORDER BY avg_air_index DESC;

-- 8) The avarage air index for each country within 6 years

SELECT Country, City, ROUND((IFNULL(SUM(`2022`),0) + IFNULL(SUM(`2021`),0) + IFNULL(SUM(`2020`),0) + 
IFNULL(SUM(`2019`),0) + IFNULL(SUM(`2018`),0) + IFNULL(SUM(`2017`),0))/6 ,2) AS avg_air_index 
FROM cleaned_data_air_index
GROUP BY 2,1
ORDER BY avg_air_index DESC;

-- 9) Percentage for each year grouping by country
...
-- 10) Percentage for each year grouping by city
...
-- 11) TOP 10 Countries which air quality has been changed to worse/better
	WITH cte as (
	SELECT Country, 
...
-- 12) Percentage air polution for each city in their country
